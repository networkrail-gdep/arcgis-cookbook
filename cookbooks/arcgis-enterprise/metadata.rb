...
recipe 'arcgis-enterprise::delete_server_site', 'Deletes ArcGIS Server site'
...
recipe 'arcgis-enterprise::portal_security', 'Updates Portal for ArcGIS security configuration'
recipe 'arcgis-enterprise::portal_settings', 'Updates Portal for ArcGIS user default settings'
recipe 'arcgis-enterprise::portal_standby', 'Installs and configures Portal for ArcGIS on standby machine'
...
recipe 'arcgis-enterprise::uninstall_datastore', 'Uninstalls ArcGIS Data Store'
recipe 'arcgis-enterprise::uninstall_portal', 'Uninstalls Portal for ArcGIS'
recipe 'arcgis-enterprise::uninstall_server', 'Uninstalls ArcGIS Server'
recipe 'arcgis-enterprise::uninstall_webadaptors', 'Uninstalls and un-deploys ArcGIS Server and Portal for ArcGIS Web Adaptors'
...
recipe 'arcgis-enterprise::unregister_portal_machine', 'Unregisters local machine from Portal for ArcGIS'
